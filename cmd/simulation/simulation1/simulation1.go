...
import (
	...
	link "github.com/jjg-akers/NetworkLayer-DataPlane/cmd/link/link1"
...
func main() {
	...
	// 	i++
	// }
	client.UdtSend(2, fmt.Sprintf("01234567890123456789012345678901234567890123456789012345678901234567890123456789"))
